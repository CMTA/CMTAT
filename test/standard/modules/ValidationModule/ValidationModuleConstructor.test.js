...
contract(
  ...
  function ([_, admin, address1, address2, address3, deployerAddress]) {
    beforeEach(async function () {
      ...
      this.cmtat =  await deployCMTATStandaloneWithParameter(deployerAddress, _, admin, 'CMTA Token', 'CMTAT', DECIMAL, 'CMTAT_ISIN', 'https://cmta.ch', this.ruleEngineMock.address, 'CMTAT_info', this.flag)
