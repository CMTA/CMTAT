...
contract('UpgradeableCMTAT - Proxy', function ([_, owner, address1]) {
  it('should increment the balance value', async function () {
    ...
    const implementationContractAddress1 = erc1967.getImplementationAddress(this.upgradeableCMTATInstance.address, {
      from: owner
    });
    ...
    const implementationContractAddress2 = erc1967.getImplementationAddress(this.upgradeableCMTATInstance.address, {
      from: owner
    })
