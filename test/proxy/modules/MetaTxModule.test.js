...
contract(
  ...
  function ([
    ...
    beforeEach(async function () {
      ...
      this.cmtat = await deployCMTATProxyWithParameter(deployerAddress, this.forwarder.address, admin, 'CMTA Token', 'CMTAT', DECIMAL, 'CMTAT_ISIN', 'https://cmta.ch', ZERO_ADDRESS, 'CMTAT_info', this.flag)
    })
