...
function SnapshotModuleMultiplePlannedTest (admin, address1, address2, address3) {
  ...
  context('SnapshotMultiplePlannedTest', function () {
    ...
    beforeEach(async function () {
      ...
      this.snapshotTime1 = this.currentTime.add(time.duration.seconds(FIRST_SNAPSHOT_INTERVAL))
      this.snapshotTime2 = this.currentTime.add(time.duration.seconds(SECOND_SNAPSHOT_INTERVAL))
      this.snapshotTime3 = this.currentTime.add(time.duration.seconds(THIRD_SNAPSHOT_INTERVAL))
    ...
    it('testCanTransferTokensAfterFirstSnapshot', async function () {
      const TRANSFER_AMOUNT_1 = BN(20)
      // Arrange - Assert
      await checkSnapshot.call(this, await time.latest(), TOTAL_SUPPLY_INITIAL_MINT, ADDRESSES, [ADDRESS1_INITIAL_MINT, ADDRESS2_INITIAL_MINT, ADDRESS3_INITIAL_MINT])
      ...
      // values now
      const address1NewTokensBalance = ADDRESS1_INITIAL_MINT.sub(TRANSFER_AMOUNT_1)
      const address2NewTokensBalance = ADDRESS2_INITIAL_MINT.add(TRANSFER_AMOUNT_1)
      await checkSnapshot.call(this, await time.latest(), TOTAL_SUPPLY_INITIAL_MINT, ADDRESSES, [address1NewTokensBalance, address2NewTokensBalance, ADDRESS3_INITIAL_MINT])
    })

    it('testCanTransferAfterSecondSnapshot', async function () {
      // We jump into the future
      await time.increase(SECOND_SNAPSHOT_INTERVAL.sub(FIRST_SNAPSHOT_INTERVAL))
      // Arrange - Assert
    ...
    it('testCanTransferTokensMultipleTimes', async function () {
      ...
      // Values at the time of the first snapshot
      await checkSnapshot.call(this, this.snapshotTime1, TOTAL_SUPPLY_INITIAL_MINT, ADDRESSES, [ADDRESS1_INITIAL_MINT, ADDRESS2_INITIAL_MINT, ADDRESS3_INITIAL_MINT])
      const ADDRESS1_BALANCE_AFTER_ONE_TRANSFER = ADDRESS1_INITIAL_MINT.sub(TRANSFER_AMOUNT_1)
      const ADDRESS2_BALANCE_AFTER_TONE_TRANSFER = ADDRESS2_INITIAL_MINT.add(TRANSFER_AMOUNT_1)
      // Values at the time of the second snapshot
      await checkSnapshot.call(this, this.snapshotTime2, TOTAL_SUPPLY_INITIAL_MINT, ADDRESSES, [ADDRESS1_BALANCE_AFTER_ONE_TRANSFER, ADDRESS2_BALANCE_AFTER_TONE_TRANSFER, ADDRESS3_INITIAL_MINT])
      // Values at the time of the third snapshot
      await checkSnapshot.call(this, this.snapshotTime3, TOTAL_SUPPLY_INITIAL_MINT, ADDRESSES, [ADDRESS1_BALANCE_AFTER_ONE_TRANSFER, ADDRESS2_BALANCE_AFTER_TONE_TRANSFER, ADDRESS3_INITIAL_MINT])
      // Values now
      await checkSnapshot.call(this, await time.latest(), TOTAL_SUPPLY_INITIAL_MINT, ADDRESSES, [ADDRESS1_BALANCE_AFTER_ONE_TRANSFER, ADDRESS2_BALANCE_AFTER_TONE_TRANSFER, ADDRESS3_INITIAL_MINT]);
      ...
      await checkSnapshot.call(this, this.snapshotTime2, TOTAL_SUPPLY_INITIAL_MINT, ADDRESSES, [ADDRESS1_BALANCE_AFTER_ONE_TRANSFER, ADDRESS2_BALANCE_AFTER_TONE_TRANSFER, ADDRESS3_INITIAL_MINT])
      // Values now
      const ADDRESS1_BALANCE_AFTER_TWO_TRANSFER = ADDRESS1_BALANCE_AFTER_ONE_TRANSFER.add(TRANSFER_AMOUNT_2)
      const ADDRESS2_BALANCE_AFTER_TWO_TRANSFER = ADDRESS2_BALANCE_AFTER_TONE_TRANSFER.sub(TRANSFER_AMOUNT_2)
      await checkSnapshot.call(this, await time.latest(), TOTAL_SUPPLY_INITIAL_MINT, ADDRESSES, [ADDRESS1_BALANCE_AFTER_TWO_TRANSFER, ADDRESS2_BALANCE_AFTER_TWO_TRANSFER, ADDRESS3_INITIAL_MINT]);
      ...
      await checkSnapshot.call(this, this.snapshotTime2, TOTAL_SUPPLY_INITIAL_MINT, ADDRESSES, [ADDRESS1_BALANCE_AFTER_ONE_TRANSFER, ADDRESS2_BALANCE_AFTER_TONE_TRANSFER, ADDRESS3_INITIAL_MINT])
      // Values at the time of the third snapshot
      await checkSnapshot.call(this, this.snapshotTime3, TOTAL_SUPPLY_INITIAL_MINT, ADDRESSES, [ADDRESS1_BALANCE_AFTER_TWO_TRANSFER, ADDRESS2_BALANCE_AFTER_TWO_TRANSFER, ADDRESS3_INITIAL_MINT])
      // Values now
      const ADDRESS1_BALANCE_AFTER_THREE_TRANSFER = ADDRESS1_BALANCE_AFTER_ONE_TRANSFER.add(TRANSFER_AMOUNT_3)
      const ADDRESS2_BALANCE_AFTER_THREE_TRANSFER = ADDRESS2_BALANCE_AFTER_TONE_TRANSFER.sub(TRANSFER_AMOUNT_3)
      await checkSnapshot.call(this, await time.latest(), TOTAL_SUPPLY_INITIAL_MINT, ADDRESSES, [ADDRESS1_BALANCE_AFTER_THREE_TRANSFER, ADDRESS2_BALANCE_AFTER_THREE_TRANSFER, ADDRESS3_INITIAL_MINT]);
