...
`ERC7551Module` is composed in `CMTATBaseERC7551` (`contracts/modules/6_CMTATBaseERC7551.sol`), which is the base for the ERC-7551 deployment variants (`CMTATStandaloneERC7551`, `CMTATUpgradeableERC7551`).
